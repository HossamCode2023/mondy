...
class CarProductGo extends StatefulWidget {
  const CarProductGo({super.key});

  @override
  State<CarProductGo> createState() => _CarProductGoState();
}

class _CarProductGoState extends State<CarProductGo> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: 
      const Center(
        child: Text(' تقرير مغادرة عربة المنتج',
      ...
      child: Column(
        children: [
          Container(
                  ...
                  child: const Center(child: Text('تقرير مغادرة عربة المنتج',
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  child: const Center(child: Text('سعت المغادرة',
                  style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.black)),
                  ),
                ),
              ),
          ...
          Container(
                  ...
                  child: const Center(child: Text('تم تفريغ العربة وتمت المغادرة',
                  style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.black)),
                  ),
                ),
        ],
