...
class MailfunctionsTable extends StatelessWidget {
  const MailfunctionsTable({super.key});
              ...
              builder: (BuildContext context,
                ...
                return DataTable2(
                  ...
                  columns: const [
                    ...
                    DataColumn2(label: Center(child: Text("Mailfunctions")), size: ColumnSize.S),
                  ...
                  rows: List<DataRow>.generate(
                    ...
                    (index) => DataRow(
                      cells: [
                        ...
                        DataCell(Center(
                          child: CustomText(
                              text: documents[index]['malfunctionsController'].toString()),
                        )),
