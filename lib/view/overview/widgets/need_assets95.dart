...
class NeedAssets95Table extends StatelessWidget {
  const NeedAssets95Table({super.key});
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: StreamBuilder(
              stream:
                  FirebaseFirestore.instance.collection('assets').orderBy('blanks95',descending: true ).endAt([124000]).snapshots(),
                  ...
                  rows: List<DataRow>.generate(
                    ...
                    (index) => DataRow(
                      cells: [
                        ...
                        DataCell(Center(
                          child: CustomText(
                              text: documents[index]['assets95'].toString()),
                        )),
